...
\Stripe\Stripe::setApiKey('sk_test_ktWbWfYcUUllGajCDLLHDGGX');
...
$charge_amount = number_format($grand_total,2) * 100; //rounded by amount of cent
$metadata = array(
    "cart_id" => $cart_id,
    "tax"     => $tax,
    "sub_total"=> $sub_total
...
<div class="container-fluid col-md-8">
    ...
    <p> Your card has been successfully charged <?=money($grand_total); ?>. Please check your email with the confirmation. Thank you!</p>
