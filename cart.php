        ...
        <?php else: ?>
                ...
                <tbody>
                   <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-xs btn-default" onclick="updateCart('removeone','<?=$product['id']; ?>');">remove</button>
                            <?=@$item['quantity']; ?>
                        </td>
            ...
            <table class="table table-bordered table-condensed">
                ...
                <thead class="totals-table-header">
                  <th class="col-sm-2">Total Items</th>
                  <th>Subtotal</th>
                  <th>Tax</th>
                  <th>Grand Total</th>
                </thead>
            ...
            <!-- Checkout Button trigger modal -->
                ...
                <!-- Checkout Modal -->
                <div class="modal fade" style="width:75%;" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModalLabel">
                      ...
                      <div class="modal-body">
                          <div class="row">
                            <form action="checkout_success.php" method="post" id="payment-form">
                                ...
                                <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').' from 88riot.'; ?>">
...
<script>
    ...
    $.ajax({
        url: '/88riot/admin/parsers/check_address.php',
        method: 'post',
        data: data,
